...
type ConfluenceClient interface {
	...
	GetPageFooterComments(ctx context.Context, pageID string, opts *confluence.ListOptions) ([]confluence.Comment, string, error)
	GetPageInlineComments(ctx context.Context, pageID string, opts *confluence.ListOptions) ([]confluence.InlineComment, string, error)
	GetFooterCommentChildren(ctx context.Context, commentID string, opts *confluence.ListOptions) ([]confluence.Comment, string, error)
	GetInlineCommentChildren(ctx context.Context, commentID string, opts *confluence.ListOptions) ([]confluence.InlineComment, string, error)
	GetFooterComment(ctx context.Context, commentID string) (*confluence.Comment, error)
	GetInlineComment(ctx context.Context, commentID string) (*confluence.InlineComment, error)
	AddComment(ctx context.Context, pageID string, body string) (*confluence.Comment, error)
	AddFooterCommentReply(ctx context.Context, parentCommentID string, storageBody string) (*confluence.Comment, error)
	AddInlineCommentReply(ctx context.Context, parentCommentID string, storageBody string) (*confluence.InlineComment, error)
